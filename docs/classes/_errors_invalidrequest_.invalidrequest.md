[WebSocketAPI - v1.1.5-1](../README.md) › [Globals](../globals.md) › ["errors/InvalidRequest"](../modules/_errors_invalidrequest_.md) › [InvalidRequest](_errors_invalidrequest_.invalidrequest.md)
