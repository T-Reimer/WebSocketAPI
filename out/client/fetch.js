        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [3 /*break*/, 7];
                case 1: return [4 /*yield*/, index_1.sendData(id, api, body, options)];
                case 2: return [2 /*return*/, _b.sent()];
                case 3: return [4 /*yield*/, index_1.sendData(id, api, body, options)];
                case 4: return [2 /*return*/, _b.sent()];
                case 5: return [4 /*yield*/, index_1.getData(id, api, body, options)];
                case 6: return [2 /*return*/, _b.sent()];
                case 7: return [4 /*yield*/, index_1.getData(id, api, body, options)];
